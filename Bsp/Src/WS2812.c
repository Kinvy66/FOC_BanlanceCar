...
void WS2812_init(void)
{
  ...
  tmr_dma_request_enable(TMR4, TMR_C4_DMA_REQUEST, TRUE);
...
//	tmr_period_buffer_enable(TMR5, TRUE);
  ...
  dma_init_struct.peripheral_base_addr = (uint32_t)&TMR4->c4dt;
  ...
  dma_flexible_config(DMA1, FLEX_CHANNEL3, DMA_FLEXIBLE_TMR4_CH4);
